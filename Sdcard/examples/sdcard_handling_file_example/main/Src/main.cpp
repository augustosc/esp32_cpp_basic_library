...
/******************************************************** 
 *                      TEST_1: 
 *              find a existing file on a directory
 * 1. mount sdcard
 * 2. find(f_name) found
 * 3. unmount sdcard
*********************************************************/
    ...
    ///////////////////////
    status = sd.lookup(BASE_PATH,lookup_file,buf);
    if(ESP_OK == status)
    ...
    // unmount fatfs
    ESP_LOGW(LOG_TAG,"STEP 3: unmount sdcard");
...
*********************************************************/
    ...
    ///////////////////////
    status = sd.lookup(dir_name,lookup_file,buf);
    if(ESP_OK == status)
...
**************************************************/
    ...
    ////////////////////////////////////////
    esp_err_t status = sd.mount(BASE_PATH,MAX_FILES);
    ...
    ////////////////////////////////////////
    total_written = sd.write(fw_name,content,content_size);
    ...
    ////////////////////////////////////////
    total_read = sd.read(fw_name,&data);
    ...
    ////////////////////////////////////////
    int ret = sd.ren(fw_name,new_name);
    ...
    ////////////////////////////////////////
    total_read = sd.read(new_name,&data);
    ...
    ESP_LOGI(LOG_TAG,"-------------------------------------------");
    ////////////////////////////////////////
    ESP_LOGW(LOG_TAG,"STEP 9: unmount sdcard");
    status = sd.unmount();
